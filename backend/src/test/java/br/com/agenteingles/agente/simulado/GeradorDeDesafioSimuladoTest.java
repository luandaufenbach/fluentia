...
class GeradorDeDesafioSimuladoTest {
    ...
    void desafioGeradoVemCompleto() {
        DesafioGerado desafio = gerador.gerar(pedido(List.of(), List.of()));
    ...
    void geradorNaoRepeteEnunciadoJaUsado() {
        ...
        for (int tentativa = 0; tentativa < 400; tentativa++) {
            todosOsEnunciados.add(gerador.gerar(pedido(List.of(), List.of())).enunciado());
        }
        ...
        DesafioGerado desafio = gerador.gerar(pedido(jaUsados, List.of()));
    ...
    void cenaAvisaOErroReforcado() {
        DesafioGerado desafio = gerador.gerar(pedido(List.of(), List.of("concordancia_do_verbo_to_be")));
